...
from amazon_config import (BASE_URL, CURRENCY, DIRECTORY, FILTERS, MAX_PRICE,
                           MIN_PRICE, NAME, get_chrome_web_driver,
                           get_web_driver_options, set_browser_as_incognito,
...
class GenerateReport:
    ...
    def get_best_item(self):
        try: 
            ...
            print(e)
            pritn("Problem with sorting items")
            return None
...
class AmazonAPI:
    ...
    def get_products_links(self):
        ...
        links = []
        try:
            results = result_list[1].find_elements_by_xpath(
